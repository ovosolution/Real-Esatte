                                ...
                                <tbody>
                                    @forelse($developers as $developer)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge--primary">{{ $developer->properties->count() }}</span>
                                            </td>
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <button type="button" class="action-btn confirmationBtn"
                                                        data-question=" @lang('Are you sure to remove this developer?')"
                                                        data-action="{{ route('admin.developer.delete', $developer->id) }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="16"
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    <div class="card table__card__wrap">
                                        <div class="table__heading d-flex align-items-center justify-content-between">
                                            <p class="table__heading__title mb-0">@lang('Developers')
                                                ({{ $developersCount }})</p>
                                            <button type="button" class="btn  btn--primary add-btn">
                                                <i class="las la-plus"></i> @lang('Add Developer')</button>
                                        </div>
                                        <table class="table border-0 p-0 mt-4 table--responsive--md">
                                            <thead>
                                                <tr>
                                                                    ...
                                                                    <svg width="16" height="16" viewBox="0 0 20 20"
                                                                        ...
                                                                        <g clip-path="url(#clip0_2514_2910)">
                                                                            ...
                                                                            <path
                                                                                ...
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                            <path d="M8.33325 5H11.6666"
                                                                                stroke="currentColor"
                                                                                stroke-width="1.66667"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                            <path d="M8.33325 8.33334H11.6666"
                                                                                stroke="currentColor"
                                                                                stroke-width="1.66667"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                            <path d="M8.33325 11.6667H11.6666"
                                                                                stroke="currentColor"
                                                                                stroke-width="1.66667"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                            <path d="M8.33325 15H11.6666"
                                                                                stroke="currentColor"
                                                                                stroke-width="1.66667"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                ...
                <div class="modal-body mb-3">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form--control form-control developer-location" name="location"
                                value="{{ old('location') }}">
                        </div>
                    </div>
    ...
    <script>
        (function ($) {
            ...
            $('.add-btn').on('click', function () {
                ...
                submitBtn.html('<i class="las la-plus"></i> @lang('
                    Add Developer ')');
            ...
            $('.edit-btn').on('click', function () {
                ...
                form.trigger('reset');
                form.attr('action',
                    "{{ route('admin.developer.store', ':id') }}"
                    .replace(':id', developer
                        .id));
                title.text("@lang('Edit developer Type')");
                submitBtn.html('<i class="las la-edit"></i> @lang('
                    Update Developer ')');
