                    ...
                    <div class="card-body card">
                        ...
                        <form class="notify-form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex gap-3 mt-4">
                                <button type="submit" class="btn btn--primary btn-send flex-grow-1"><i class="las la-paper-plane"></i> @lang('Send Now')</button>
...
<script>
    ...
    (function ($) {
        ...
        $('.btn-schedule').on('click', function () {
            ...
            const $startLabel = $('label[for="start"]');
            const $batchInput = $('input[name=batch]');
            const $batchLabel = $('label[for="batch"]');
            const $coolingInput = $('input[name=cooling_time]');
            const $coolingLabel = $('label[for="cooling_time"]');
            ...
            if ($(this).hasClass('active')) {
                ...
                $coolingInput.prop('required', false);
                $startLabel.removeClass('required');
                $batchLabel.removeClass('required');
                $coolingLabel.removeClass('required');
                $btnSend.text('@lang("Schedule Notification")');
            } else {
                ...
                $coolingInput.prop('required', true);
                $startLabel.addClass('required');
                $batchLabel.addClass('required');
                $coolingLabel.addClass('required');
                $btnSend.html('<i class="las la-paper-plane"></i> @lang("Send Now")');
            }
        });
    })(jQuery);
