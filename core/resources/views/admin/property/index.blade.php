                        ...
                        <tbody>
                            ...
                            @forelse($properties as $property)
                                <tr>
                                    ...
                                    <td>{{ $property->latitude . ', ' . $property->longitude }}
                                    </td>
                                                    ...
                                                    <g>
                                                        ...
                                                        <g clip-path="url(#a)"
                                                            ...
                                                            <path
                                                                ...
                                                                transform="translate(275 415)" fill="none"
                                                                stroke="#000000" stroke-width="30"
                                                            ...
                                                            <path
                                                                ...
                                                                style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                transform="translate(491.143 434.573)" fill="none"
                                                                stroke="#000000" stroke-width="30"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-miterlimit="10" stroke-dasharray="none"
                                                                stroke-opacity="" data-original="#000000"></path>
                                                            <path d="m0 0 56.568-56.568"
                                                                style="stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                                                                transform="translate(406.29 462.857)" fill="none"
                                                                stroke="#000000" stroke-width="30"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-miterlimit="10" stroke-dasharray="none"
                                                                stroke-opacity="" data-original="#000000"></path>
            ...
            <div class="col-lg-auto">
                <div class="dashboard-body__heading__wrap">
                    ...
                    <div class="dashboard-body__heading">
                        ...
                        <p class="dashboard-body__desc">@lang('Add and manage property listings with accurate
                            coordinates')</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.property.store') }}" method="POST"
                    ...
                    <div class="modal-body mb-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form--label required">@lang('Price')
                                    ({{ gs('cur_sym') }})</label>
                            ...
                            <div class="col-12">
                                <div class="google__info d-flex align-items-center gap-2"> <svg width="16" height="16"
                                        ...
                                        <path
                                            ...
                                            stroke="#1D4ED8" stroke-width="1.33333" stroke-linecap="round"
                            ...
                            <div class="col-lg-12">
                                <p class="form__tip">💡 @lang('Tip: Right-click on Google Maps and select the
                                    coordinates to copy them accurately.')</p>
                            </div>

                            <div class="col-12">
                                <label class="form--label">@lang('Description')</label>
                                <textarea name="description" rows="3" class="form--control form-control"
                            ...
                            <div class="col-12">
                                ...
                                <div class="upload-box">
                                    <input type="file" name="images[]" id="propertyImages" multiple hidden>

                                    <label for="propertyImages" class="upload-area">
                                        <div class="upload-content">
                                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                                                <path d="M12 16V4M12 4L7 9M12 4L17 9" stroke="#8A94A6" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    d="M4 16V18C4 19.1046 4.89543 20 6 20H18C19.1046 20 20 19.1046 20 18V16"
                                                    stroke="#8A94A6" stroke-width="2" stroke-linecap="round" />
                                            </svg>

                                            <p class="upload-title">Click to upload or drag and drop</p>
                                            <p class="upload-subtitle">PNG, JPG up to 10MB</p>
                                        </div>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="flexSwitchCheckDefault">@lang('Enable or
    ...
    <div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            ...
            <div class="prorerty__wrap">
                    ...
                    <p class="text-muted"><i class="las la-map-marker"></i> <span class="property-address"></span>
                    </p>
        ...
        <script>
            (function ($) {
                ...
                $('.edit-btn').on('click', function () {
                    ...
                    modal.find('select[name=construction_status]').val(resource.construction_status)
                        .change();
                ...
                $('.view-btn').on('click', function () {
                    ...
                    if (resource.images && resource.images.length > 0) {
                        resource.images.forEach(function (img) {
                            ...
                            imageHtml +=
                                `<div class="col-6"><img src="${fullPath}" class="img-fluid rounded w-100" style="height: 200px; object-fit: cover;" alt="Property Image"></div>`;
                        });
                    } else {
