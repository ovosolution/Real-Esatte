                        ...
                        <div class="modal-body mb-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form--control form-control" name="title" value="{{ old('title') }}" placeholder="@lang('e.g., Luxury 4BR Apartment')">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form--control form-control" name="price" value="{{ old('price') }}" placeholder="85000000">
                                </div>

                                <div class="col-md-6">
                                    <label class="form--label">@lang('Bedrooms')</label>
                                    <input type="number" class="form--control form-control" name="bedrooms" value="{{ old('bedrooms') }}" placeholder="0">
                                </div>

                                <div class="col-md-6">
                                    <label class="form--label">@lang('Bathrooms')</label>
                                    <input type="number" class="form--control form-control" name="bathrooms" value="{{ old('bathrooms') }}" placeholder="0">
                                </div>

                                <div class="col-md-6">
                                    <label class="form--label">@lang('Size (in sqft)')</label>
                                    <input type="number" class="form--control form-control" name="size" value="{{ old('size') }}" placeholder="1200">
                                </div>

                                <div class="col-md-6">
                                    <label class="form--label">24/7 @lang('Security')</label>
                                    <select name="security" class="form-select select2">
                                        <option value="" disabled selected>@lang('Select Security')</option>
                                ...
                                <div class="col-md-6">
                                    <label class="form--label">@lang('CCTV')</label>
                                    <select name="cctv" class="form-select select2">
                                        <option value="" disabled selected>@lang('Select CCTV')</option>
                                        <option value="1">@lang('Yes')</option>
                                        <option value="0">@lang('No')</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form--label">@lang('Fire Alarm')</label>
                                    <select name="fire_alarm" class="form-select select2">
                                        <option value="" disabled selected>@lang('Select Fire Alarm')</option>
                                        <option value="1">@lang('Yes')</option>
                                        <option value="0">@lang('No')</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form--label">@lang('Boys Quarters')</label>
                                    <select name="boys_quarter" class="form-select select2">
                                        <option value="" disabled selected>@lang('Select Boys Quarters')</option>
                                        <option value="1">@lang('Yes')</option>
                                        <option value="0">@lang('No')</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form--label">@lang('C of O')</label>
                                    <select name="co" class="form-select select2">
                                        <option value="" disabled selected>@lang('Select C of O')</option>
                                        <option value="1">@lang('Yes')</option>
                                        <option value="0">@lang('No')</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form--label">24 @lang('Hours Electricity')</label>
                                    <select name="electricity" class="form-select select2">
                                        <option value="" disabled selected>@lang('Select Electricity')</option>
                                        <option value="1">@lang('Yes')</option>
                                        <option value="0">@lang('No')</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form--control form-control" name="address" value="{{ old('address') }}" placeholder="@lang('15 Admiralty Way, Lekki Phase 1, Lagos')">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form--control form-control" name="latitude" value="{{ old('latitude') }}" placeholder="6.4474">
                                </div>

                                <div class="col-md-6">
                                    <label class="form--label">@lang('Longitude')</label>
                                    <input type="text" class="form--control form-control" name="longitude" value="{{ old('longitude') }}" placeholder="3.4650">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" rows="3" class="form--control form-control" value="{{ old('description') }}" placeholder="@lang('Describe the property features, amenities, and unique selling points...')"></textarea>
                                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="prorerty__wrap__main">
                            <div class="prorerty__wrap">
                            ...
                            <div>
                                <span class="badge badge--success radius-2">Active</span>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-6 col-md-6">
                                ...
                                <span class="fw-bold property-type property__value"></span>
                            </div>
                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Developer')</small>
                                <span class="fw-bold property-developer property__value"></span>
                            </div>
                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Bedrooms')</small>
                                <span class="fw-bold property-bedrooms property__value"></span>
                            </div>
                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Bathrooms')</small>
                                <span class="fw-bold property-bathrooms property__value"></span>
                            </div>
                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Location')</small>
                                <span class="fw-bold property-location property__value"></span>
                            </div>
                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Added Date')</small>
                                <span class="fw-bold property-date property__value"></span>
                            </div>
                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Construction Status')</small>
                                <span class="fw-bold property-construction-status property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Listing Type')</small>
                                <span class="fw-bold property-listing-type property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Pricing Type')</small>
                                <span class="fw-bold property-pricing-type property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Size (in sqft)')</small>
                                <span class="fw-bold property-size property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">24/7 @lang('Security')</small>
                                <span class="fw-bold property-security property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('CCTV')</small>
                                <span class="fw-bold property-cctv property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Fire Alarm')</small>
                                <span class="fw-bold property-fire-alarm property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('Boys Quarters')</small>
                                <span class="fw-bold property-boys-quarter property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">@lang('C of O')</small>
                                <span class="fw-bold property-co property__value"></span>
                            </div>

                            <div class="col-6 col-md-6">
                                <small class="text-muted d-block">24 @lang('Hours Electricity')</small>
                                <span class="fw-bold property-electricity property__value"></span>
                            </div>

                        </div>

                        <div class="p-3 bg--light rounded mb-4 google__wrapper">
                            <h6 class="mb-2 google__title"><i class="las la-map"></i> @lang('Google Coordinates')</h6>
                            <div class="row">
                                <div class="col-6">
                                    <small class="text-muted d-block">@lang('Latitude')</small>
                                    <span class="fw-bold latitude-text google__value"></span>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted d-block">@lang('Longitude')</small>
                                    <span class="fw-bold longitude-text google__value"></span>
                                </div>
                            </div>
                        </div>
            ...
            <script>
                (function ($) {
                    ...
                    $('.edit-btn').on('click', function () {
                        ...
                        modal.find('input[name=size]').val(resource.size);
                        modal.find('select[name=security]').val(resource.security).change();
                        modal.find('select[name=cctv]').val(resource.cctv).change();
                        modal.find('select[name=fire_alarm]').val(resource.fire_alarm).change();
                        modal.find('select[name=boys_quarter]').val(resource.boys_quarter).change();
                        modal.find('select[name=co]').val(resource.co).change();
                        modal.find('select[name=electricity]').val(resource.electricity).change();
                    ...
                    $('.view-btn').on('click', function () {
                        ...
                        modal.find('.property-size').text(resource.size);

                        modal.find('.property-security').text(resource.security == 1 ? '@lang("Yes")' : '@lang("No")');
                        modal.find('.property-cctv').text(resource.cctv == 1 ? '@lang("Yes")' : '@lang("No")');
                        modal.find('.property-fire-alarm').text(resource.fire_alarm == 1 ? '@lang("Yes")' : '@lang("No")');
                        modal.find('.property-boys-quarter').text(resource.boys_quarter == 1 ? '@lang("Yes")' : '@lang("No")');
                        modal.find('.property-co').text(resource.co == 1 ? '@lang("Yes")' : '@lang("No")');
                        modal.find('.property-electricity').text(resource.electricity == 1 ? '@lang("Yes")' : '@lang("No")');
