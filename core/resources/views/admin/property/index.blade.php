                ...
                <form action="{{ route('admin.property.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body mb-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="location_id" class="form-select select2">
                                    ...
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}" {{ old('location_id') }}>
                            ...
                            <div class="col-12">
                                <div class="google__info d-flex align-items-center gap-2"> <svg width="16"
                                    ...
                                    <label for="propertyImages" class="upload-area">
                                        <div class="upload-content">
                                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                                                <path d="M12 16V4M12 4L7 9M12 4L17 9" stroke="#8A94A6"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label"
                                        for="flexSwitchCheckDefault">@lang('Enable or
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn Reject__btn"
        ...
        <script>
            (function($) {
                ...
                $('.view-btn').on('click', function() {
                    ...
                    modal.find('.property-price').text("{{ gs('cur_sym') }}" + parseFloat(
                    ...
                    modal.find('.property-construction-status').text(
                        resource.construction_status == 1 ? '@lang('Available')' :
                    ...
                    if (resource.images && resource.images.length > 0) {
                        ...
                        imageHtml =
                            '<div class="col-12 text-center text-muted">@lang('No images available')</div>';
                    }
