                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dashboard__card">
                        <div>
                            ...
                            <h3 class="dashboard__card__point">{{ $activeUsers }}</h3>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dashboard__card">
                        <div>
                            ...
                            <h3 class="dashboard__card__point">{{ $pendingUsers }}</h3>
                        </div>
                        <div class="dashboard__card__icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dashboard__card">
                        <div>
                            ...
                            <h3 class="dashboard__card__point">{{ $activeListings }}</h3>
                        </div>
                        <div class="dashboard__card__icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dashboard__card">
                        <div>
                            ...
                            <h3 class="dashboard__card__point">{{ $activeSubscriptions }}</h3>
                        </div>
                        <div class="dashboard__card__icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row gy-4 ">
                <div class="col-lg-6 col-sm-6">
                    <div class="pending__reviews">
                        ...
                        @forelse ($pendingUsersReview as $pendingUser)
                            <div class="pending__reviews__items">
                                <div>
                                    <p class="pending__reviews__items__title">{{ $pendingUser->firstname }}</p>
                                    <p class="pending__reviews__items__desc">@lang('Realtor Verification')</p>
                                </div>
                                <div>
                                    <p class="pending__reviews__date">{{ $pendingUser->created_at->diffForHumans() }}</p>
                                </div>
                            </div>
                        @empty
                            <p class="text-center">@lang('No pending verifications')</p>
                        @endforelse
                        ...
                        @forelse ($locationDistribution as $location)
                            <div class="listing-item">
                                <div class="item-header">
                                    ...
                                    <span class="listing-count">{{ $location->total }} {{ strPluralize($location->total, 'Listing') }}</span>
                                </div>
                                <div class="bar-container">
                                    <div class="bar" style="width: {{ $location->percentage }}%;"></div>
                                </div>
                            </div>
                        @empty
                            <p class="text-center">@lang('No location data available')</p>
                        @endforelse
...
@push('script')
    <script>
        ...
        ========================= */
        const weeklyLabels = @json($weekLabels);
