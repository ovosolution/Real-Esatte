...
<div class="dashboard-body">
            ...
            <div class="col-lg-12">
                <div class="dashboard-body__heading__wrap">
                    ...
                    <div class="dashboard-body__heading">
                        <h3 class="dashboard-body__title">@lang('Dashboard Overview')</h3>
                        <p class="dashboard-body__desc">@lang('Quick snapshot of system health and performance')</p>
                    </div>
        ...
        <div class="row gy-4  ">
            <div class="col-lg-3 col-sm-6">
                <div class="dashboard__card">
                    <div>
                        <p class="dashboard__card__title">@lang('Total Verified')</p>
                        <p class="dashboard__card__desc">@lang('Realtors')</p>
                        <h3 class="dashboard__card__point">1,284</h3>
                    </div>
                    <div class="dashboard__card__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.801 10C22.2577 12.2413 21.9322 14.5714 20.8789 16.6018C19.8255 18.6322 18.1079 20.2401 16.0125 21.1573C13.9171 22.0746 11.5706 22.2458 9.36431 21.6424C7.15798 21.039 5.2252 19.6974 3.88828 17.8414C2.55137 15.9854 1.89113 13.7272 2.01767 11.4434C2.14421 9.15954 3.04989 6.9881 4.58366 5.29118C6.11743 3.59426 8.18659 2.47444 10.4461 2.11846C12.7056 1.76248 15.0188 2.19186 17 3.335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dashboard__card">
                    <div>
                        <p class="dashboard__card__title">@lang('Pending')</p>
                        <p class="dashboard__card__desc">@lang('Verifications')</p>
                        <h3 class="dashboard__card__point">1,284</h3>
                    </div>
                    <div class="dashboard__card__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dashboard__card">
                    <div>
                        <p class="dashboard__card__title">@lang('Active')</p>
                        <p class="dashboard__card__desc">@lang('listings')</p>
                        <h3 class="dashboard__card__point">1,284</h3>
                    </div>
                    <div class="dashboard__card__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dashboard__card">
                    <div>
                        <p class="dashboard__card__title">@lang('Active')</p>
                        <p class="dashboard__card__desc">@lang('Subscriptions')</p>
                        <h3 class="dashboard__card__point">1,284</h3>
                    </div>
                    <div class="dashboard__card__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row gy-4 mb-4">
            <div class="col-lg-12">
                <div class="quick__actions">
                    <p class="quick__actions__title">@lang('Quick Actions')</p>
        ...
        <div class="row gy-4 mb-4">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="dashboard__Chart">
                    ...
                    <p class="dashboard__chart__title">@lang('Weekly Activity')</p>

                    <canvas id="weeklyActivity" height="120"></canvas>
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="dashboard__Chart">
                    ...
                    <p class="dashboard__chart__title">@lang('Active Listings by Location')</p>

                    <canvas id="listingsByLocation" height="120"></canvas>
                </div>
            </div>
        ...
        <div class="row gy-4 ">
            <div class="col-lg-6 col-sm-6">
                <div class="pending__reviews">
                    <p class="pending__reviews__title">@lang('Pending Reviews')</p>
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="pending__reviews h-100">
                    <p class="pending__reviews__title">@lang('Location Distribution')</p>
                    <div class="listing-item">
                        <div class="item-header">
                            <span class="location-icon">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M13.3334 6.66665C13.3334 9.99531 9.64069 13.462 8.40069 14.5326C8.28517 14.6195 8.14455 14.6665 8.00002 14.6665C7.85549 14.6665 7.71487 14.6195 7.59935 14.5326C6.35935 13.462 2.66669 9.99531 2.66669 6.66665C2.66669 5.25216 3.22859 3.8956 4.22878 2.89541C5.22898 1.89522 6.58553 1.33331 8.00002 1.33331C9.41451 1.33331 10.7711 1.89522 11.7713 2.89541C12.7715 3.8956 13.3334 5.25216 13.3334 6.66665Z" stroke="#1D4ED8" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8 8.66669C9.10457 8.66669 10 7.77126 10 6.66669C10 5.56212 9.10457 4.66669 8 4.66669C6.89543 4.66669 6 5.56212 6 6.66669C6 7.77126 6.89543 8.66669 8 8.66669Z" stroke="#1D4ED8" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="btn approve__btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-3">
                    <div class="analytics__card">
                        <div class="analytics__card__content">
                            <p class="analytics__card__title">Total Revenue</p>
                            <h3 class="analytics__card__desc">₦12.4M</h3>
                            <p class="analytics__card__bottom-desc"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        ...
        ========================= */
        const locationCtx = document.getElementById('listingsByLocation').getContext('2d');

        new Chart(locationCtx, {
            type: 'bar',
            data: {
                labels: ['Lagos', 'Abuja', 'Asaba', 'Ibadan', 'Others'],
                datasets: [{
                    data: [1200, 950, 700, 450, 250],
