                            ...
                            <form method="POST">
                                ...
                                <div class="row mt-4 d-none configForm" id="clickatell">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('API Key')" name="clickatell_api_key" value="{{ @$smsConfig->clickatell->api_key }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4 d-none configForm" id="infobip">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('Username')" name="infobip_username" value="{{ @$smsConfig->infobip->username }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Password') </label>
                                            <input type="text" class="form-control" placeholder="@lang('Password')" name="infobip_password" value="{{ @$smsConfig->infobip->password }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4 d-none configForm" id="messageBird">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>@lang('API Key') </label>
                                            <input type="text" class="form-control" placeholder="@lang('API Key')" name="message_bird_api_key" value="{{ @$smsConfig->message_bird->api_key }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4 d-none configForm" id="nexmo">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('API Key') </label>
                                            <input type="text" class="form-control" placeholder="@lang('API Key')" name="nexmo_api_key" value="{{ @$smsConfig->nexmo->api_key }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('API Secret') </label>
                                            <input type="text" class="form-control" placeholder="@lang('API Secret')" name="nexmo_api_secret" value="{{ @$smsConfig->nexmo->api_secret }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4 d-none configForm" id="smsBroadcast">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Username') </label>
                                            <input type="text" class="form-control" placeholder="@lang('Username')" name="sms_broadcast_username" value="{{ @$smsConfig->sms_broadcast->username }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Password') </label>
                                            <input type="text" class="form-control" placeholder="@lang('Password')" name="sms_broadcast_password" value="{{ @$smsConfig->sms_broadcast->password }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4 d-none configForm" id="twilio">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('Account SID')" name="account_sid" value="{{ @$smsConfig->twilio->account_sid }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>@lang('Auth Token') </label>
                                            <input type="text" class="form-control" placeholder="@lang('Auth Token')" name="auth_token" value="{{ @$smsConfig->twilio->auth_token }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>@lang('From Number') </label>
                                            <input type="text" class="form-control" placeholder="@lang('From Number')" name="from" value="{{ @$smsConfig->twilio->from }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4 d-none configForm" id="textMagic">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Username') </label>
                                            <input type="text" class="form-control" placeholder="@lang('Username')" name="text_magic_username" value="{{ @$smsConfig->text_magic->username }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Apiv2 Key') </label>
                                            <input type="text" class="form-control" placeholder="@lang('Apiv2 Key')" name="apiv2_key" value="{{ @$smsConfig->text_magic->apiv2_key }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="custom_api_url" value="{{ @$smsConfig->custom->url }}" placeholder="@lang('API URL')">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                                ...
                                                <div class="card-body">
                                                    <div class="headerFields">
                                                        @for ($i = 0; $i < count(gs('sms_config')->custom->headers->name); $i++)
                                                            <div class="row mt-3">
                                                                <div class="col-md-5">
                                                                    <input type="text" name="custom_header_name[]" class="form-control" value="{{ @$smsConfig->custom->headers->name[$i] }}" placeholder="@lang('Headers Name')">
                                                                </div>
                                                                <div class="col-md-5">
                                                                    <input type="text" name="custom_header_value[]" class="form-control" value="{{ @$smsConfig->custom->headers->value[$i] }}" placeholder="@lang('Headers Value')">
                                                                </div>
                                                                <div class="col-md-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="bodyFields">
                                                        @for ($i = 0; $i < count(gs('sms_config')->custom->body->name); $i++)
                                                            <div class="row mt-3">
                                                                <div class="col-md-5">
                                                                    <input type="text" name="custom_body_name[]" class="form-control" value="{{ @$smsConfig->custom->body->name[$i] }}" placeholder="@lang('Body Name')">
                                                                </div>
                                                                <div class="col-md-5">
                                                                    <input type="text" name="custom_body_value[]" value="{{ @$smsConfig->custom->body->value[$i] }}" class="form-control" placeholder="@lang('Body Value')">
                                                                </div>
                                                                <div class="col-md-2">
        ...
        <div class="col-lg-auto">
            <div class="dashboard-body__heading__wrap">
                ...
                <div class="dashboard-body__heading">
                    <h3 class="dashboard-body__title">@lang('SMS Setting')</h3>
                    <p class="dashboard-body__desc">@lang('Add and manage SMS settings')</p>
                </div>
            </div>
        </div>

        <div class="col-lg-auto">
                <button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal" class="btn btn--primary "> <i class="fa-regular fa-paper-plane"></i> @lang('Send Test SMS')</button>
        </div>
    </div>
@endpush
