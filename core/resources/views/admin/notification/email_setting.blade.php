        ...
        <div class="col-lg-auto">
            <div class="dashboard-body__heading__wrap">
                ...
                <div class="dashboard-body__heading">
                    <h3 class="dashboard-body__title">@lang('Email Setting')</h3>
                    <p class="dashboard-body__desc">@lang('Add and manage email settings')</p>
                </div>
            </div>
        </div>

        <div class="col-lg-auto">
            <button type="button" data-bs-target="#testMailModal" data-bs-toggle="modal" class="btn  btn--primary"><i class="fa-regular fa-paper-plane"></i> @lang('Send Test Mail')</button>
        </div>
    </div>
@endpush
