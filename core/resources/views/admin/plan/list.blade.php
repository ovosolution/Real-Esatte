        ...
        <div class="row mt-4 justify-content-center">
            <div class="col-lg-3">
                <div class="role__card card">
                    ...
                    <span>
                        <h3 class="role__card__price">{{ $freeUsers }}</h3>
                    </span>
                    <p class="role__card__desc">{{ $freeUserPercentage }}% @lang('of total')</p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="role__card card">
                    ...
                    <span>
                        <h3 class="role__card__price">{{ $weeklyUsers }}</h3>
                    </span>
                    <p class="role__card__desc">{{ $weeklyUserPercentage }}% @lang('of total')</p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="role__card card">
                    ...
                    <span>
                        <h3 class="role__card__price">{{ $monthlyUsers }}</h3>
                    </span>
                    <p class="role__card__desc">{{ $monthlyUserPercentage }}% @lang('of total')</p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="role__card card">
                    ...
                    <span>
                        <h3 class="role__card__price">{{ $yearlyUsers }}</h3>
                    </span>
                    <p class="role__card__desc">{{ $yearlyUserPercentage }}% @lang('of total')</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card table__card__wrap">
                ...
                <table class="table border-0  mt-4 p-0 table--responsive--md">
                    ...
                    <tbody>
                        @forelse ($planPurchasedUsers as $planPurchasedUser)
                            <tr>
                                <td>{{ $planPurchasedUser->firstname . ' ' . $planPurchasedUser->lastname }}</td>
                                <td>{{ $planPurchasedUser->plan_name }}</td>
                                <td><span class="badge badge--success">Active</span></td>
                                <td>
                                    {{ showDateTime($planPurchasedUser->start_date) }}
                                </td>
                                <td>{{ showDateTime($planPurchasedUser->end_date) }}</td>
                                <td>{{ showAmount($planPurchasedUser->plan_price) }}</td>
                                <td>
