                            ...
                            <div class="col-12">
                                <div class=" d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="form-check form-switch form--switch pl-0 form-switch-success">
                                        <input class="form-check-input check-all-permission" type="checkbox" role="switch" @checked($permissions->count() == $existingPermissions->count())>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="border border-1 d-flex  p-3 h-100 flex-column rounded group-permission-list">
                                        <div class="py-2">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="form-check form-switch form--switch pl-0 form-switch-success">
                                                    <input class="form-check-input check-group-permission" type="checkbox" role="switch" @checked($groupExistingpermissionCount == $permission->count())>
                                                </div>
                                            </div>
                                            <hr class="mb-0 mt-2">
                                        </div>
                                        <div class="permission-list mt-2">
                                            @foreach ($permission as $singlePermission)
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="form-check form-switch form--switch pl-0 form-switch-success">
                                                        <input class="form-check-input" type="checkbox" role="switch" id="permission-{{ $singlePermission->id }}" value="{{ $singlePermission->id }}" name="permissions[]" @checked(in_array($singlePermission->id, $existingPermissionIds))>
                                                    </div>
                                                    <label class="form-check-label" for="permission-{{ $singlePermission->id }}">
